...
var crpstudio = (function ($, crpstudio) {
  ...
  crpstudio.svg = (function ($, config) {
    ...
    var marginLeft = 10,      // Margin of whole figure
        ...
        loc_svgRoot = null,
        loc_dDivFeat = "#sentdetails_feats",
    ...
    return {
      ...
      toggle_svg: function (elRect) {
        ...
        try {
          ...
          // Show the error at the indicated place
          private_methods.showError("toggle_svg error: ", ex);
        }
      },
      ...
      */
      node_svg: function (elRect, bGetId) {
        ...
        try {
          ...
          if (oNode.hasOwnProperty("f")) {
            ...
            $(loc_dDivFeat).html(lHtml.join("\n"));
            elTarget = $(loc_dDivFeat).find(".svg-features").get(0);
            ...
            $(loc_dDivFeat).removeClass("hidden");
          ...
          // Show the error at the indicated place
          private_methods.showError("node_svg error: ", ex);
        }
      },
      node_fix_svg: function (elRect) {
        ...
        try {
          ...
          // Show the error at the indicated place
          private_methods.showError("node_fix_svg error: ", ex);
        }
      },
      node_stop_svg: function (elRect) {
        if (!loc_bKeep) {
          $(loc_dDivFeat).addClass("hidden");
          loc_iCurrentNode = -1;
        }
      }
