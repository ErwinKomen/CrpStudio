...
Crpstudio.dbase = {
      ...
      switch (target) {
        ...
        case "dbase_explore":
          ...
          if (sRecentDb && sRecentDb !== "") {
            ...
            Crpstudio.dbase.recentDb = sRecentDb;
          } 
          break;
        default:
          break;
  ...
  setDbase : function(target, sDbName, sLng, sDir, sDbase) {
    ...
    Crpstudio.dbase.currentDb = sDbName;
  ...
  ctlChanged : function(source) {
    // Validate source
    if (!source || source === null) source = Crpstudio.dbase.ctlCurrent;
    // Clear any previously set timer
    clearTimeout(Crpstudio.dbase.typingTimer);
    // Find parameters
    var sKey = "";
    ...
    var oChanges = { "dbase": Crpstudio.dbase.currentDb,
