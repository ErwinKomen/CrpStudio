...
var crpstudio = (function (crpstudio) {
  ...
  crpstudio.config = {
    ...
    prj_access: [
      ...
      {name: "qwiz", id: "QwizId", listfield: "Name", sortfield: "Name",  sorttype: "txt", 
        descr: "qwiz_description", prf: "qwz", download: "qwiz_download",
        before: function(sType, iItemId) { return crpstudio.project.setCrpItemBefore(sType, iItemId);}, 
        after: function(sType, iItemId, bSelLocal, oArgs) { crpstudio.project.setCrpItemAfter(sType, iItemId, bSelLocal, oArgs);},
        gen: "qwiz_general", cur: "qwiz_current", divprf: "qwiz", fields: [
            { field: "Name",        type: "txt", loc: "qwiz_general_name"}, 
            { field: "search",      type: "txt", loc: "qwiz_general_search"}, 
            { field: "feats",       type: "txt", loc: "qwiz_general_feats"}, 
            { field: "input",       type: "txt", loc: "qwiz_general_input"}, 
            { field: "Goal",        type: "txt", loc: "qwiz_general_goal"}, 
            { field: "Comment",     type: "txt", loc: "qwiz_general_comment"}, 
            { field: "Text",        type: "txt", loc: "qwiz_general_text"}, 
            { field: "Created",     type: "cap", loc: "qwiz_general_datecreated"}, 
            { field: "Changed",     type: "cap", loc: "qwiz_general_datechanged"}]},
      {name: "cns", id: "CnsId", listfield: "name", sortfield: "CnsId",  sorttype: "int", 
        descr: "cns_description",  prf: "cns", download: "",
        before: function(sType, iItemId) { return crpstudio.project.setCrpItemBefore(sType, iItemId);}, 
        after: function(sType, iItemId, bSelLocal, oArgs) { crpstudio.project.setCrpItemAfter(sType, iItemId, bSelLocal, oArgs);},
        gen: "cns_general", cur: "cns_current", divprf: "cns", fields: [
            { field: "name",        type: "txt", loc: "cns_general_name"}, 
            { field: "type",        type: "txt", loc: "cns_general_type"}, 
            { field: "pos",         type: "txt", loc: "cns_general_pos"}, 
            { field: "rel",         type: "txt", loc: "cns_general_rel"}, 
            { field: "towards",     type: "txt", loc: "cns_general_towards"}, 
            { field: "unique",      type: "txt", loc: "cns_general_unique"}, 
            { field: "QwizId",      type: "txt", loc: "cns_general_qwizid"}]},
      {name: "cnd", id: "CndId", listfield: "name", sortfield: "CndId",  sorttype: "int", 
        descr: "cnd_description",  prf: "cnd", download: "",
        before: function(sType, iItemId) { return crpstudio.project.setCrpItemBefore(sType, iItemId);}, 
        after: function(sType, iItemId, bSelLocal, oArgs) { crpstudio.project.setCrpItemAfter(sType, iItemId, bSelLocal, oArgs);},
        gen: "cnd_general", cur: "cnd_current", divprf: "cnd", fields: [
            { field: "var",         type: "txt", loc: "cnd_general_var"}, 
            { field: "pos",         type: "txt", loc: "cnd_general_pos"}, 
            { field: "rel",         type: "txt", loc: "cnd_general_rel"}, 
            { field: "towards",     type: "txt", loc: "cnd_general_towards"}, 
            { field: "QwizId",      type: "txt", loc: "cnd_general_qwizid"}]},
