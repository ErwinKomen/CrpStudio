...
var crpstudio = (function (crpstudio) {
  ...
  crpstudio.config = {
    ...
    prj_access: [
      ...
      {name: "corpus", id: "CorpusId", listfield: "Name", sortfield: "Name", 
        descr: "corpus_description", prf: "cor", 
        before: null, after: null,
        gen: "corpus_general", cur: "crp_current", divprf: "corpus", fields: [
            { field: "Name",        type: "txt", loc: "corpus_general_name"}, 
            { field: "File",        type: "txt", loc: ""}, 
            { field: "Goal",        type: "txt", loc: "corpus_general_goal"}, 
            { field: "Comment",     type: "txt", loc: "corpus_general_comment"}, 
            { field: "Text",        type: "txt", loc: "corpus_general_text"}, 
            { field: "Created",     type: "cap", loc: "corpus_general_datecreated"}, 
            { field: "Changed",     type: "cap", loc: "corpus_general_datechanged"}]},
      {name: "grouping", id: "GrpId", listfield: "Name", sortfield: "Name", 
        ...
        gen: "grouping_general", cur: "grp_current", divprf: "grouping", fields: [
            ...
            { field: "File",        type: "txt", loc: ""}, 
            { field: "Goal",        type: "txt", loc: "grouping_general_goal"}, 
            { field: "Comment",     type: "txt", loc: "grouping_general_comment"}, 
            { field: "Text",        type: "txt", loc: "grouping_general_text"}, 
            { field: "Created",     type: "cap", loc: "grouping_general_datecreated"}, 
            { field: "Changed",     type: "cap", loc: "grouping_general_datechanged"}]},
      {name: "metavar", id: "MtvId", listfield: "Name", sortfield: "Name", 
        ...
        gen: "metavar_general", cur: "mtv_current", divprf: "metavar", fields: [
            ...
            { field: "File",        type: "txt", loc: ""}, 
            { field: "Goal",        type: "txt", loc: "metavar_general_goal"}, 
            { field: "Comment",     type: "txt", loc: "metavar_general_comment"}, 
            { field: "Text",        type: "txt", loc: "metavar_general_text"}, 
            { field: "Created",     type: "cap", loc: "metavar_general_datecreated"}, 
            { field: "Changed",     type: "cap", loc: "metavar_general_datechanged"}]},
      {name: "dbase", id: "DbaseId", listfield: "Name", sortfield: "Name", 
        descr: "dbase_description", prf: "qry", 
        before: null, after: null,
